<?php
$us_listado = array(
array('usu_cedula' => '01','usu_nombres' => 'Bodega Principal'),
array('usu_cedula'=>'02','usu_nombres' => 'Bodega de reservas'),
);
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Bodega <span id="formulario_titulo"></span></h4>
      </div>
...
<input type="hidden" id="id" name="id" value="">
  ...
  <div class="form-group">
    <label for="apellidos" class="col-sm-2 control-label">Ubicación:</label>
    <div class="col-sm-10">
