<?php
$us_listado = array(
array('usu_cedula' => '1','usu_nombres' => 'BIC', 'usu_correo_electronico' => 'Datos'),
array('usu_cedula'=>'2','usu_nombres' => 'BIC', 'usu_correo_electronico' => 'Internet'),
array('usu_cedula'=>'3','usu_nombres' => 'Grayman','usu_correo_electronico' => 'Producto'),
);
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Oportunidad <span id="formulario_titulo"></span></h4>
      </div>
...
<input type="hidden" id="id" name="id" value="">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="cedula" name="cedula" placeholder="" value='4'>
    </div>
  </div>
  <div class="form-group">
    <label for="nombres" class="col-sm-2 control-label">Cuenta:</label>
    <div class="col-sm-10">
      <select class="form-control" id="nombres" name="nombres" placeholder="">
<option>- ESCOJA LA CUENTA -</option>
<option></option>
        </select>
    </div>
  </div>
  <div class="form-group">
    <label for="nombres" class="col-sm-2 control-label">Contacto:</label>
    <div class="col-sm-10">
      <select class="form-control" id="nombres" name="nombres" placeholder="">
<option>- ESCOJA EL CONTACTO -</option>
<option></option>
        </select>
    </div>
  </div>
  <div class="form-group">
    <label for="nombres" class="col-sm-2 control-label">Usuario comercial:</label>
    <div class="col-sm-10">
      <select class="form-control" id="nombres" name="nombres" placeholder="">
<option>- ESCOJA EL USUARIO COMERCIAL -</option>
<option></option>
        </select>
    </div>
  </div>
  <div class="form-group">
    <label for="nombres" class="col-sm-2 control-label">Usuario técnico:</label>
    <div class="col-sm-10">
      <select class="form-control" id="nombres" name="nombres" placeholder="">
<option>- ESCOJA EL USUARIO TECNICO -</option>
<option></option>
        </select>
    </div>
  </div>
  <div class="form-group">
    <label for="nombres" class="col-sm-2 control-label">Tipo:</label>
    <div class="col-sm-10">
      <select class="form-control" id="nombres" name="nombres" placeholder="">
...
<option>Producto</option>
  ...
  <div class="form-group">
    <label for="cedula" class="col-sm-2 control-label">Comentario:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="cedula" name="cedula" placeholder="">
    </div>
  </div>

<h2>Campos exclusivos para tipo "Internet"</h2>
...
<option>No exitosa</option>
        </select>
    </div>
  </div>
  <div class="form-group">
    <label for="nombres" class="col-sm-2 control-label">Proveedor:</label>
    <div class="col-sm-10">
      <select class="form-control" id="nombres" name="nombres" placeholder="">
<option>- ESCOJA EL PROVEEDOR -</option>
<option>Datos</option>
<option>Producto</option>
        </select>
    </div>
  ...
  <div class="form-group">
    <label for="nombres" class="col-sm-2 control-label">Provincia:</label>
    <div class="col-sm-10">
      <select class="form-control" id="nombres" name="nombres" placeholder="">
<option>- ESCOJA LA PROVINCIA -</option>
<option>Datos</option>
<option>Producto</option>
        </select>
    </div>
  ...
  <div class="form-group">
    <label for="nombres" class="col-sm-2 control-label">Cantón:</label>
    <div class="col-sm-10">
      <select class="form-control" id="nombres" name="nombres" placeholder="">
<option>- ESCOJA EL CANTON -</option>
<option>Datos</option>
<option>Producto</option>
        </select>
    </div>
  ...
  <div class="form-group">
    <label for="nombres" class="col-sm-2 control-label">Parroquia:</label>
    <div class="col-sm-10">
      <select class="form-control" id="nombres" name="nombres" placeholder="">
<option>- ESCOJA LA PARROQUIA -</option>
<option>Datos</option>
<option>Producto</option>
        </select>
    </div>
  ...
  <div class="form-group">
    <label for="cedula" class="col-sm-2 control-label">Sector:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="cedula" name="cedula" placeholder="">
    </div>
  </div>
  <div class="form-group">
    <label for="cedula" class="col-sm-2 control-label">Dirección:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="cedula" name="cedula" placeholder="">
    </div>
  </div>
  <div class="form-group">
    <label for="cedula" class="col-sm-2 control-label">Capacidad:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="cedula" name="cedula" placeholder="">
    </div>
  </div>
  <div class="form-group">
    <label for="cedula" class="col-sm-2 control-label">Coordenada (longitud):</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="cedula" name="cedula" placeholder="">
    </div>
  </div>
  <div class="form-group">
    <label for="cedula" class="col-sm-2 control-label">Coordenada (latitud):</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="cedula" name="cedula" placeholder="">
    </div>
  </div>
