<?php
//$us_listado = q("SELECT *, (SELECT rol_nombre FROM sai_rol WHERE rol_id=usu_rol) AS rol FROM sai_usuario ORDER BY usu_cedula");
$rol = $_SESSION['rol'];
...
$us_listado = q("SELECT *, (SELECT rol_nombre FROM sai_rol WHERE rol_id=usu_rol) AS rol FROM sai_usuario WHERE 1=1 $filtro ORDER BY usu_borrado DESC, usu_apellidos");
