...
$rol_id = $_SESSION['rol'];
$result = q("SELECT usu_cedula, usu_password FROM sai_usuario WHERE usu_id=$usu_id");
...
*/
        ...
        if ($encuesta['enc_finalizada']) { 
            ...
            //print_r(q("SELECT * FROM sai_tipo_pregunta"));
...
q("UPDATE sai_evaluacion SET eva_porcentaje_avance=$porcentaje_avance_total WHERE eva_id=$eva_id");
//echo "Avance Total: " . $porcentaje_avance_total;
echo '</ul>';
//q("INSERT INTO sai_tipo_pregunta(tpp_clave, tpp_etiqueta) VALUES('multitexto', 'multitexto')");
?>
