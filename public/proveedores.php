<?php
$us_listado = array(
array('usu_cedula' => '1798765432001','usu_nombres' => 'CNT'),
array('usu_cedula'=>'0412345678001','usu_nombres' => 'Movistar'),
);
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Proveedor <span id="formulario_titulo"></span></h4>
      </div>
...
<input type="hidden" id="id" name="id" value="">
  <div class="form-group">
    <label for="cedula" class="col-sm-2 control-label">RUC:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="cedula" name="cedula" placeholder="">
    </div>
  </div>
  <div class="form-group">
    <label for="nombres" class="col-sm-2 control-label">Nombre Comercial:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="nombres" name="nombres" placeholder="">
    </div>
  </div>
  <div class="form-group">
    <label for="apellidos" class="col-sm-2 control-label">Razón Social:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label for="departamento" class="col-sm-2 control-label">Nombre vendedor:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="departamento" name="departamento" placeholder="">
    </div>
  </div>
  <div class="form-group">
    <label for="correo_electronico" class="col-sm-2 control-label">Correo vendedor:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="correo_electronico" name="correo_electronico" placeholder="">
    </div>
  </div>
  <div class="form-group">
    <label for="telefono" class="col-sm-2 control-label">Teléfono vendedor:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="telefono" name="telefono" placeholder="">
    </div>
  </div>
  <div class="form-group">
    <label for="telefono" class="col-sm-2 control-label">Plantilla:</label>
    <div class="col-sm-10">
      <input type="file" class="form-control" id="telefono" name="telefono" placeholder="">
    </div>
  </div>
</form>
