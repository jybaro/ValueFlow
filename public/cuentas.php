<?php
$us_listado = array(
array('usu_cedula' => '1798765432001','usu_nombres' => 'BIC', 'usu_correo_electronico' => 'Independiente'),
array('usu_cedula'=>'0412345678001','usu_nombres' => 'Grayman', 'usu_correo_electronico' => 'Independiente'),
);
...
<input type="hidden" id="id" name="id" value="">
  ...
  <div class="form-group">
    <label for="direccion" class="col-sm-2 control-label">Dirección correspondencia:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label for="departamento" class="col-sm-2 control-label">Tipo de cuenta:</label>
    <div class="col-sm-10">
      <select class="form-control" id="departamento" name="departamento" placeholder="">
